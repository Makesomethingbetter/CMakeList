...
//登陆window
    ...
    gtk_window_set_title(GTK_WINDOW(logWindow),"sign up&sign in");
...
//place组件
    ...
    gtk_fixed_put(GTK_FIXED(fixed_log),passwdEntry,170,180);
    gtk_fixed_put(GTK_FIXED(fixed_log),label_passwd,80,190);
    ...
    gtk_fixed_put(GTK_FIXED(fixed_log),buttonSignIn,150,280);
    gtk_fixed_put(GTK_FIXED(fixed_log),buttonSignUp,390,280);
